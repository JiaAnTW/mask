        ...
        success: function(data) {
            ...
            data["features"].forEach((Element,Index)=>{
                    ...
                    if(Element["properties"]["note"].indexOf("號")!=-1)
                        markerList.push(L.marker([Element["geometry"]["coordinates"][1], Element["geometry"]["coordinates"][0]], {icon: blueIcon}).on("click",()=>{handleClick(Element)}))
                    else if(Element["properties"]["mask_adult"]>50)
                        markerList.push(L.marker([Element["geometry"]["coordinates"][1], Element["geometry"]["coordinates"][0]], {icon: greenIcon}).on("click",()=>{handleClick(Element)}))
                    else if(Element["properties"]["mask_adult"]>0)
                        markerList.push(L.marker([Element["geometry"]["coordinates"][1], Element["geometry"]["coordinates"][0]], {icon: yellowIcon}).on("click",()=>{handleClick(Element)}))
                    else
                        markerList.push(L.marker([Element["geometry"]["coordinates"][1], Element["geometry"]["coordinates"][0]], {icon: redIcon}).on("click",()=>{handleClick(Element)}))
                    }
